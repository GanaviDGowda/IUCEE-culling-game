-- Migration 027: Prevent CIE bonus from overwriting manually saved attendance
...
BEGIN
  ...
  LOOP
    ...
    -- DO NOTHING on conflict to prevent overwriting attendance that the admin already manually saved
